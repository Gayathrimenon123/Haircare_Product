                               ...
                               ?>
                                ...
                                <div class="col-md-6 fashion-grid" >
                                 ...
                                 foreach($arr_ph as $i){
                                    ...
                                    ?>
                                    <a href="#"><img src="<?php echo $i;?>" alt="hello" style="height: 200px;width: 300px;border: 5px solid green;"/>
                                    ...
                                    <div class="fashion-view"><span></span>
                                               ...
                                               <?php
                                          echo'  <h4><a href="login.php?id='.$row['id'].'">Quick View</a></h4>';
                                            ?>
                                    </div>
                                </div>
                            </div>
