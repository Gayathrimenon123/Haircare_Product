...
<body>
    <br>
<h2 style="margin-left:460px;">ADD CARD DETAILS</h2>
...
<table style="margin-left:40px;">
   ...
   <!-- <tr><td> ID       :</td><td><input type="text" name="a" value="<?php echo $row['id']; ?>" readonly></td></tr> -->
    <tr><td>Card No     :</td><td><input type="text" name="b" class="form-control" maxlength="10" ></td></tr>
    ...
    <tr><td colspan="2" align="center"><input type="submit" class="btn btn-success" value="ADD"></td></tr>
 </table>
    </div></div>
