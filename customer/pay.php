...
// echo $data;
        ...
        <form method="POST">
                            ...
                            <div class="pay_info">
                                <div class="row">
                                    <div class="col-md-6 tab-grid">
                                        ...
                                        <h5 class="head_agileinfo text-center text-capitalize pb-5">
                                        <!--<span>Amount:<label style="color:red">$</label> </span>{{amount}}</h5>-->
            ...
            <td><select class="form-control"  name="cid" >
                <option>-------Select---------</option>
                    ...
                    ?>
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input class="billing-address-name form-control" type="text" name="amount" value="<?php echo $dat[0]; ?>" readonly="" >
                                                            </div>
                                                            </div>
                                                            <div class="clear"> </div>
                                                        </div>
