       ...
       alert("required 10 digits, match requested format!");
        ...
        if (isset($_POST['submit'])) {  
            ...
            if ($fetch['count'] > 0) {
                ...
                $qry = "insert into tbl_supplier(staffid,supname,supphone,supemail,supcity,supdistrict,suppincode,supstate,date) values('$staffid','$name','$phone','$email','$city','$district','$pin','$state','$sdate')";
