...
if (isset($_REQUEST['submit'])) {
    ...
    // } else {
        $qry = "insert into tbl_product (pname,cat,description,itemimage,rate,stock,status,scat,sid,starvalue) values('$pname','$cat','$description','$mimage','$rate','$stock','1','$scat','$staffid','$star')";
...
<?php
 include '../connection.php';
    $qry = mysqli_query($conn,"select * FROM tbl_product WHERE STATUS='1' AND `sid`='$staffid'");
