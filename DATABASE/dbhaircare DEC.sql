...
--
-- Host: localhost
-- Generation Time: Dec 10, 2021 at 10:33 AM
...
(2, 8888888888, 'cera joy', '2021-12-12', 'Master card', 1),
(3, 8989898989, 'gopika', '2022-04-22', 'visa card', 3),
(4, 7777777777, 'jeena', '2021-12-10', 'Debit card', 6);
...
(42, 72, 1, 2, 1400, '2021-11-24', 3, 'Order Placed'),
(44, 71, 8, 1, 300, '2021-12-10', 1, 'Order Pending'),
(45, 73, 8, 29, 8700, '2021-12-10', 6, 'Order Placed');
...
(71, 1, 300, 'Order Pending'),
(72, 3, 1400, 'Order Placed'),
(73, 6, 8700, 'Order Placed');
...
(7, 'jisna', 'jose', '8080808080', 'rosevilla', 'thrissur', 'Ernakulam', 680666, 'kerala', 'jisna@gmail.com', '1', '2021-11-25');
...
(19, 'jisna@gmail.com', 'jisna@123', 'Customer');
...
(8, 72, '2021-11-24', 'paid'),
(9, 73, '2021-12-10', 'paid');
...
(8, 3, 8, 3, '666', '1400', 'paid', '2021-11-24'),
(9, 6, 9, 4, '777', '8700', 'paid', '2021-12-10');
...
INSERT INTO `tbl_product` (`id`, `brand`, `pname`, `cat`, `description`, `itemimage`, `rate`, `stock`, `status`, `scat`, `starvalue`) VALUES
(1, '', 'Loreal', '1', 'quality product', '../images/shampo.jpg', '700', 55, 1, '1', 4),
(2, '', 'Himalaya', '1', 'quality', '../images/h1.jpg', '', 96, 1, '1', 3),
(3, '', 'Himalaya', '1', 'qulity with quantity', '../images/h1.jpg', '300', 290, 1, '2', 4),
...
(7, '', 'Dhathri', '2', 'For Hair growth', '../images/hairoil.jpg', '400', 260, 1, '3', 3),
(8, 'Dhathri', 'Dhathri purifying shampooo', '1', 'quality product', '../images/hnoil.jpg', '300', 1, 1, '2', 3);
...
INSERT INTO `tbl_purchasechild` (`pchildid`, `pmasterid`, `itemid`, `costprice`, `sellingprice`, `quantity`, `totalprice`, `supid`, `date`) VALUES
(11, 8, 7, 350, 0, 50, 17500, 0, '2021-11-19'),
(12, 9, 0, 280, 0, 69, 19320, 0, '2021-11-19'),
(13, 9, 7, 280, 0, 40, 11200, 0, '2021-11-19'),
(19, 15, 3, 200, 300, 30, 6000, 6, '2021-12-09'),
(20, 15, 7, 100, 200, 10, 1000, 7, '2021-12-09'),
(21, 16, 7, 200, 400, 10, 2000, 2, '2021-12-09'),
(22, 16, 7, 200, 400, 20, 4000, 6, '2021-12-09'),
(28, 18, 8, 300, 400, 10, 3000, 3, '2021-12-10'),
(29, 19, 8, 200, 300, 20, 4000, 2, '2021-12-10');
...
INSERT INTO `tbl_purchasemaster` (`pmasterid`, `staffid`, `totalamt`, `pstatus`) VALUES
(8, 2, 350, ''),
(9, 1, 560, ''),
(15, 4, 7000, 'Purchased'),
(16, 3, 6000, 'Purchased'),
