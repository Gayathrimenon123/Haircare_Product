...
<tr>
            <td>Product Name</td>
            <td><input type="text"  class="form-control" name="pdt" required></td>
        </tr>
        <tr>
            <td>Description</td>
        ...
        <!-- <tr>
            <td>Rate</td>
            <td><input type="text"  name="ratee" class="form-control" required></td>
        </tr>
        <tr>
            <td>Stock</td>
...
if (isset($_REQUEST['submit'])) {
    ...
    // } else {
        $qry = "insert into tbl_product (brand,pname,cat,description,itemimage,status,scat,starvalue) values('$pname','$pdt','$cat','$description','$mimage','1','$scat','$star')";
        // $qry = "insert into tbl_product (pname,cat,description,itemimage,rate,stock,status,scat,starvalue) values('$pname','$cat','$description','$mimage','$rate','$stock','1','$scat','$star')";
